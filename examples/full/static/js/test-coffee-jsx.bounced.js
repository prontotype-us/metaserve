...
Avatar = React.createClass({
  render: function() {
    return React.createElement("img", {
      "src": this.props.face.image_urls.normal
    });
  }
});

$.getJSON('http://uifaces.com/api/v1/random', function(face) {
  return React.render(React.createElement(Avatar, {
    "face": face
  }), $('#face')[0]);
});
...
},{"jquery":3,"react":149}],2:[function(require,module,exports){
