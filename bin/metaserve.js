...
(function() {
  var HOST, PORT, argv, coffee, de_res, fs, http, jade, metaserve, send, server, styl, uglify, url;
  ...
  module.exports = metaserve = function(base_dir, opts) {
    ...
    return function(req, res, next) {
      ...
      return send(req, url.parse(req.url).pathname).root(base_dir).on('error', function(err) {
        return next(err);
      }).pipe(res);
    };
  };
