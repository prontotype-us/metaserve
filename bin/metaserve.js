...
(function() {
  var BASE_DIR, HOST, PORT, argv, coffee, de_res, fs, http, jade, metaserve, send, server, styl, uglify, url;
  ...
  module.exports = metaserve = function(base_dir, opts) {
    ...
    return function(req, res, next) {
      var compiled_str, compiler, ext, file_stats, file_str, filename, filepath, matched, metadata, uext, _ref;
