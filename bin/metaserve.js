...
(function() {
  var BASE_DIR, CONFIG_FILE, CSS_COMPILER, DEFAULT_BASE_DIR, DEFAULT_COMPILERS, HOST, HTML_COMPILER, JS_COMPILER, PORT, VERBOSE, app, argv, compilers, config, de_res, defaults, e, express, file_path, fs, isArray, isString, metaserve_compile, metaserve_middleware, path, url, util;
